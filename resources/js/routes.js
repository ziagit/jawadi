...
import Location from './components/frontend/order/Location'
import Service from './components/frontend/order/Service'
import Time from './components/frontend/order/Time'
import JobContact from './components/frontend/order/Contact'
import Payment from './components/frontend/order/Payment'
import Status from './components/frontend/order/Status'
import Need from './components/frontend/order/Need'
import Category from './components/frontend/order/Category'
import Budget from './components/frontend/order/Budget'
            ...
            children: [
                ...
                { name: 'rating', path: '/rating', component: Rating },
                {
                    ...
                    children: [
                        ...
                        { name: 'location', path: 'location', component: Location, /* beforeEnter: orderGuard */ },
                        { name: 'time', path: 'time', component: Time },
