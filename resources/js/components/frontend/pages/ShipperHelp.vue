  ...
  <div class="container">
    <div class="left">
      ...
      <md-steppers md-vertical :md-active-step.sync="active">
        ...
        <md-step
          id="second"
          md-label="Are carriers required to have cargo liability insurance?"
          md-description="Click to read more"
        >
          <div class="md-body">
        ...
        <md-step
          id="sixth"
          md-label="I need to reset my ShippingTAP password"
          md-description="Click to read more"
        >
          <div class="md-body">
        ...
        <md-step
          id="eighth"
          md-label="Reporting a cargo damage claim"
          md-description="Click to read more"
        >
          <div class="md-body">
