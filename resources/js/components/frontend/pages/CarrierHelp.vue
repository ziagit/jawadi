  ...
  <div class="container">
    <div class="left">
      ...
      <md-steppers md-vertical :md-active-step.sync="active">
        <md-step
          id="first"
          md-label="Equipment and plated trailer requirements"
        ...
        <md-step
          id="second"
          md-label="Plated trailer requirements"
          md-description="Click to read more"
        >
          <div class="md-body-1">
        ...
        <md-step
          id="third"
          md-label="Signing up to be a carrier"
          md-description="Click to read more"
        >
        ...
        <md-step
          id="sixth"
          md-label="Using the ShippingTAP app"
          md-description="Click to read more"
        >
          <div class="md-title">How does the ShippingTAP app work?</div>
          <div class="md-body-1">
        ...
        <md-step
          id="seventh"
          md-label="Using the ShippingTAP web portal"
          md-description="Click to read more"
        >
        ...
        <md-step
          id="eighth"
          md-label="Carrier payment and accessorials guide"
          md-description="Click to read more"
        >
        ...
        <md-step
          id="nineth"
          md-label="How to update my expired documents"
          md-description="Click to read more"
        >
        ...
        <md-step
          id="tenth"
          md-label="How to contact ShippingTAP"
          md-description="Click to read more"
        >
        ...
        <md-step
          id="fifteenth"
          md-label="Tracking and Location data-sharing"
          md-description="Click to read more"
        >
          <div class="md-body-1">
        ...
        <md-step
          id="sixteenth"
          md-label="Location data-sharing"
          md-description="Click to read more"
        >
